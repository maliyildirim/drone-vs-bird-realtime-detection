...
The classifier dataset was created from cropped object regions and mined false-positive background samples.
...
The classifier was also evaluated on a separate evaluation set.
